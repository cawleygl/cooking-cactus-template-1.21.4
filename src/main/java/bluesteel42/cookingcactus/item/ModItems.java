package bluesteel42.cookingcactus.item;

import bluesteel42.cookingcactus.CookingCactus;
...
//        final Item item = new Item(new Item.Settings().registryKey(registryKey));
//        // Register the item.
